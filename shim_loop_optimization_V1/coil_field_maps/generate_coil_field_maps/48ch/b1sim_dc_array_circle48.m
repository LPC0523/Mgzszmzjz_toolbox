% Calculates B0 field components generated by 48 channel array of single-turn loops
% tiled on a close-fitting helmet
%
...
output_stem='dc_array_circle48';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
circle_radius=36; % radius (mm) hard-coded for 48ch array
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[cx,cy,cz]=textread('array_circle48.txt','%f %f %f');
% adjust coil center position
cy = cy+5;
cz = cz - 23;
...
%%%%%%%%%%% save data %%%%%%%%%%%%%%
 save b1_48ch_save.mat b1_z b1_x b1_y fov_x fov_y fov_z
