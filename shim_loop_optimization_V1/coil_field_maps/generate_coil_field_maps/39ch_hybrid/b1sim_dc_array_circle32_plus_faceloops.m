% Calculates B0 field components generated by 31 channel array of
% single-turn loops patterned on a close-fitting helmet
% plus 8 additional 5-turn loops over the face area:  39 channels in total
%
...
output_stem='hybrid_rf_shim_coil_faceloops_39ch';

[cx,cy,cz]=textread('array_circle32_plus_faceloops.txt','%f %f %f');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ports=39; % number of channels
circle_radius=47.5; % radius (mm) of single-turn loops in 31ch helmet array
faceloop_radius = 30;   % radius of faceloops (mm) 
...
circle_radius(32:end) = faceloop_radius;  % only 31 RF channels on 7T array
...
if faceloop_number_of_turns > 1
    ...
    b1_z(:,:,:,32:end) = faceloop_number_of_turns*b1_z(:,:,:,32:end);
