% Calculates B0 field components generated by 32 channel array of
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
circle_radius=46; % loop radius hard-coded (mm)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% adjust helmet center position
cz = cz - 10;  
cy = cy + 11;


ports=32; % number of channels
...
save b1_32ch_save.mat b1_z b1_x b1_y fov_x fov_y fov_z
