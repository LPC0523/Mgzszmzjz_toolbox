% Calculates B0 field components generated by 8 channel encircling array of
% loop coils
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
coil_radius=65;  % set coil radius
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[cx,cy,cz]=textread('array_circle8.txt','%f,%f,%f');
...
circle_radius=repmat(coil_radius,[ports, 1]);
...
%%%%%%%%%%% formating b1 %%%%%%%%%%%%%%
figure;
slice(fov_x,fov_y,fov_z,b1_effect_total,[],[],30); %z=0 plane
colormap(gray);
...
%%%%%%%%%%% save data %%%%%%%%%%%%%%
save b1_8ch_save.mat b1_x b1_y b1_z fov_x fov_y fov_z