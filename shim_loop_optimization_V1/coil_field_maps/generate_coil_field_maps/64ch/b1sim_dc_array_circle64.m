% Calculates B0 field components generated by 64 channel array of single-turn loops
% patterned on a close-fitting helmet
%
...
output_stem='dc_array_circle64';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
circle_radius=31.6; % loop radius (mm) matches coil described in Keil et al, MRM, 2012
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[cx,cy,cz]=textread('array_circle64.txt','%f %f %f');

% adjust geometry slightly
cz = cz - 5;

ports=64; % number of channels (for some reason, 36 channels are in the data file)
...
%%%%%%%%%%% save data %%%%%%%%%%%%%%
save b1_64ch_save.mat b1_z b1_x b1_y fov_x fov_y fov_z
