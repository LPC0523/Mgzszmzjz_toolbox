...
mni_t1 = "Nifti/SF_map_processing_nii/phj_dic_nii/MNI152_T1_1mm_brain.nii.gz"
mask_mni = "Nifti/SF_map_processing_nii/phj_dic_nii/pfc_mask_v3.nii.gz"
...
mask_data = nib.load('Nifti/SF_map_processing_nii/phj_dic_nii/pfc_mask_phj.nii.gz').get_fdata()
B0_data[mask_data < 0.5] = np.nan  
...
savemat('Nifti/SF_map_processing_nii/phj_dic_nii/B0_map_phj.mat', {'B0_map': B0_data[:,:,:], 'X': X[:,:,:] / 1000, 'Y': Y[:,:,:] / 1000, 'Z': Z[:,:,:] / 1000})

# Load saved data for further processing
B0_map = loadmat("Nifti/SF_map_processing_nii/phj_dic_nii/B0_map_phj.mat")
...
vox_pos = np.asarray([B0_map['X'], B0_map['Y'], B0_map['Z']])
...
savemat('Nifti/SF_map_processing_nii/phj_dic_nii/B0_map_phj_valid.mat', {
