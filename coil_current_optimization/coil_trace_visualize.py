...
# Load NIfTI file
img = nib.load('B0map_cal/Nifti/KLE_nii/kle_reference_nii/kle_reference_deltaB0_ppm.nii.gz')
...
savemat('B0_map.mat', {'B0_map': B0_data[:,:,:], 'X': X[:,:,:] / 1000, 'Y': Y[:,:,:] / 1000, 'Z': Z[:,:,:] / 1000})
